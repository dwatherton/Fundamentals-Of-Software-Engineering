...
public class ForgotPasswordServlet extends HttpServlet
{
    ...
    private static final String JSP_VIEW_PATH = "/WEB-INF/jsp/forgotpassword.jsp";
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (resetPasswordSubmitted)
        {
                    ...
                    || request.getParameter("newPassword").equals("") || request.getParameter("confirmPassword").equals(""))
            {
                ...
                response.sendRedirect("/Login_Application/ForgotPassword");
            ...
            else
            {
                try
                {
                    ...
                    if (userInformationMatches)
                    {
                        ...
                        if (request.getParameter("newPassword").equals(request.getParameter("confirmPassword")))
                        {
                            ...
                            response.sendRedirect("/Login_Application/Login");
                        }
                ...
                catch (SQLException e)
                {
                    ...
                    out.write("Stack Trace: " + e.getStackTrace().getClass() + "\n");
                }
