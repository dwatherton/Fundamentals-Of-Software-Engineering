                ...
                <ul class="nav nav-pills pull-right">
                    ...
                    <c:choose>
                        <c:when test="${!empty account}">
                            <%-- When user is logged in show Logged-In as active if uri ends with "/Logged-In" and Logout as inactive --%>
                            <li<c:if test="${fn:endsWith(uri,'Logged-In')}"> class="active"</c:if>><a href="${pageContext.request.contextPath}/Logged-In">Logged-In</a></li>
